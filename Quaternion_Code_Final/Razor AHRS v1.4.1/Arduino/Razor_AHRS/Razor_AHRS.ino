...
#define ACCEL_X_MIN ((float) -291.85)
#define ACCEL_X_MAX ((float) 230.4)
#define ACCEL_Y_MIN ((float) -238.1)
#define ACCEL_Y_MAX ((float) 279.04)
#define ACCEL_Z_MIN ((float) -250.88)
...
const float magn_ellipsoid_center[3] = {356.754, -144.178, 14.4041};
const float magn_ellipsoid_transform[3][3] = {{0.927647, 0.00584366, -0.00997017}, {0.00584366, 0.926138, 0.00767369}, {-0.00997017, 0.00767369, 0.997983}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
#define GYRO_AVERAGE_OFFSET_X ((float) -26.19)
#define GYRO_AVERAGE_OFFSET_Y ((float) 45.50)
#define GYRO_AVERAGE_OFFSET_Z ((float) -4.80)
